...
<body>
  <div class="max-w-[490px] mx-auto mt-[100px] px-6">
    ...
    <form action="./index.php" method="post" class="flex flex-col gap-4 mt-6">
        ...
        <button type="submit" class="bg-[#7C3AED] text-white font-bold p-2 mt-4 hover:bg-[#6b21a8] transition">Sign In</button>
      </form>

      <!-- // bottom section -->
      <p class="text-center mt-6">Don't have an account? <a href="" class="text-[#7C3AED] font-bold">Register</a></p>
  </div>
